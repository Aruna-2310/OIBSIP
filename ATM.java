            ...
            if(userid.length()==6){
                ...
                if(user_p!=pin){
                   while(true){
                       ...
                       if(count==5){
                           System.out.println("The limit has been exceeded. Please try again later");
                           break;
                   ...
                   switch(opt){
                       ...
                       case 2: System.out.println("Enter amount of cash to withdraw:");
                               ...
                               if(withdrawal>balance || balance==0){
                                   System.out.println("Your account have insufficient balance\funds.");
                                   System.out.println();
                                   break;
                               }
                       ...
                       case 3: System.out.println("Enter amount to deposit:");
                               ...
                               System.out.println();
                               break;
                       case 4: System.out.println("Enter the receiver bank account number to transfer amount.");
                               ...
                               if(acc_no.length()==10){
                                   ...
                                   if(amt<=balance){
                                       ...
                                       System.out.println("Your account have insufficient funds\balance. Please try transfering within your balance.");
                                   }
                               }
                               else{
                               ...
                               System.out.println();
                               break;
                       case 5: System.out.println("ThankYou for using ATM services. Hope you visit again!!!");
                               System.out.println();
                               break;
                       default:
